...
const translations = {
    ru: {
        ...
        'admin.enter': 'Войти',
        'admin.logout': 'Выйти',
        'admin.set_password': 'Установить пароль',
        'admin.set_password_title': 'Установить пароль администратора',
        'admin.new_password': 'Новый пароль (минимум 12 символов)',
        'admin.confirm_password': 'Повторите новый пароль',
        'admin.password_min_length': 'Пароль должен содержать не менее 12 символов.',
        'admin.passwords_do_not_match': 'Пароли не совпадают.',
        'admin.password_updated': 'Пароль успешно установлен.',
    ...
    en: {
        ...
        'admin.set_password_title': 'Set administrator password',
        'admin.new_password': 'New password (at least 12 characters)',
        'admin.confirm_password': 'Confirm new password',
        'admin.password_min_length': 'The password must contain at least 12 characters.',
        'admin.passwords_do_not_match': 'The passwords do not match.',
        'admin.password_updated': 'The password was set successfully.',
